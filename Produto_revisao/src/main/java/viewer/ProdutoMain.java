...
public class ProdutoMain extends javax.swing.JFrame {
    ...
    private GerInterGrafica genIG;
    private AbstractModelTable produtoModelTable;
    
    public ProdutoMain(GerInterGrafica newGerenIG) {
        genIG = newGerenIG;
        initComponents();
        this.setResizable(false);
        produtoModelTable = new AbstractModelTable();
        jTable3.setModel(produtoModelTable);
    }
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        genIG.carregarComboBoxCategoria(cmbCategoria);
    ...
    private void btnInsCategoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsCategoriaActionPerformed
       String desc = txtNomeCategoria.getText();
       
        try {
            genIG.getGerDom().inserirCategoria(desc);
            genIG.carregarComboBoxCategoria(cmbCategoria);
        } catch (ClassNotFoundException ex) {
            JOptionPane.showMessageDialog(this, "Erro ao inserir categoria classe");
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(this, "Erro ao inserir categoria banco");
        }  
    ...
    private void btnInsProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsProdutoActionPerformed
        ...
        int quanti = Integer.parseInt(txtQtde.getText());
        double preco = Double.parseDouble(txtPreco.getText());
        Categoria categoria = (Categoria) cmbCategoria.getSelectedItem();
        
        Produto prod = new Produto(nomeProd, quanti, preco, categoria);
        
        try {
            genIG.getGerDom().inserirProduto(prod);
        } catch (ClassNotFoundException ex) {
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        ...
        try {
            Produto prod = genIG.getGerDom().pesquisarProduto(idProd);
            if (prod == null) {
                JOptionPane.showMessageDialog(this, "Erro ao pesquisar produto.", "ERRO NA PESQUISA", JOptionPane.ERROR_MESSAGE);
                return;
            }
            txtIdProduto.setText(String.valueOf(prod.getIdProduto()));
            txtNomeProduto.setText(prod.getNome());
            txtQtde.setText(String.valueOf(prod.getIdProduto()));
            txtPreco.setText(String.format("%.2f", prod.getPreco()));
            cmbCategoria.setSelectedItem(prod.getCategoria());  
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(this, "Erro ao pesquisar produto");
        } catch (ClassNotFoundException ex) {
            JOptionPane.showMessageDialog(this, "Erro ao pesquisar produto");
        }
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        ...
        try {
            ...
            if (prod == null) {
                ...
                prod.setQuantidade(quanti);
                prod.setPreco(preco);
                prod.setCategoria(categoria);
                genIG.getGerDom().alterarProduto(prod);
            }
        } catch (SQLException ex) {
    ...
    private void btnListarTodosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListarTodosActionPerformed
        try {
            List<Produto> lista = genIG.getGerDom().mostrarTodoProdutos();
            produtoModelTable.setLista(lista);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(ProdutoMain.class.getName()).log(Level.SEVERE, null, ex);
        } catch (SQLException ex) {
            Logger.getLogger(ProdutoMain.class.getName()).log(Level.SEVERE, null, ex);
        }   
        produtoModelTable.getLista();
    ...
    private void btnListarEstoqueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListarEstoqueActionPerformed
        ...
        try {
            List<Produto> lista = genIG.getGerDom().mostrarProdutoLimite(limite);
            produtoModelTable.setLista(lista);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(ProdutoMain.class.getName()).log(Level.SEVERE, null, ex);
        } catch (SQLException ex) {
    ...
    private void btnListarCategoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListarCategoriaActionPerformed
        ...
        try {
            List<Produto> lista = genIG.getGerDom().mostrarProdutoCategoria(categoria);
            produtoModelTable.setLista(lista);
        } catch (SQLException ex) {
            Logger.getLogger(ProdutoMain.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
